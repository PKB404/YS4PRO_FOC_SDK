 ...
 * @retval None
 */
__STATIC_INLINE void LL_RCC_LSE_DisableHighDriveMode(void) { CLEAR_BIT(RCC->BDCR, RCC_BDCR_LSEMOD); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RCC_SetDSIClockSource(uint32_t Source) { MODIFY_REG(RCC->DCKCFGR, RCC_DCKCFGR_DSISEL, Source); }
#endif /* DSI */
 ...
 *         @arg @ref LL_RCC_CEC_CLKSOURCE_LSE
 */
__STATIC_INLINE uint32_t LL_RCC_GetCECClockSource(uint32_t CECx) { return (uint32_t)(READ_BIT(RCC->DCKCFGR2, CECx)); }
#endif /* CEC */
 ...
 *         @arg @ref LL_RCC_DSI_CLKSOURCE_PLL
 */
__STATIC_INLINE uint32_t LL_RCC_GetDSIClockSource(uint32_t DSIx) { return (uint32_t)(READ_BIT(RCC->DCKCFGR, DSIx)); }
#endif /* DSI */
 ...
 *         @arg @ref LL_RCC_RTC_HSE_DIV_31
 */
__STATIC_INLINE uint32_t LL_RCC_GetRTC_HSEPrescaler(void) { return (uint32_t)(READ_BIT(RCC->CFGR, RCC_CFGR_RTCPRE)); }
 ...
 *         @arg @ref LL_RCC_TIM_PRESCALER_FOUR_TIMES
 */
__STATIC_INLINE uint32_t LL_RCC_GetTIMPrescaler(void) { return (uint32_t)(READ_BIT(RCC->DCKCFGR, RCC_DCKCFGR_TIMPRE)); }
 ...
 *         @arg @ref LL_RCC_PLLP_DIV_8
 */
__STATIC_INLINE uint32_t LL_RCC_PLL_GetP(void) { return (uint32_t)(READ_BIT(RCC->PLLCFGR, RCC_PLLCFGR_PLLP)); }
 ...
 *         @arg @ref LL_RCC_PLLDIVR_DIV_31
 */
__STATIC_INLINE uint32_t LL_RCC_PLL_GetDIVR(void) { return (uint32_t)(READ_BIT(RCC->DCKCFGR, RCC_DCKCFGR_PLLDIVR)); }
#endif /* RCC_DCKCFGR_PLLDIVR */
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RCC_PLL_SpreadSpectrum_Enable(void) { SET_BIT(RCC->SSCGR, RCC_SSCGR_SSCGEN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RCC_PLL_SpreadSpectrum_Disable(void) { CLEAR_BIT(RCC->SSCGR, RCC_SSCGR_SSCGEN); }
