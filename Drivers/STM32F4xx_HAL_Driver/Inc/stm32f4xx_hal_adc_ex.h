 ...
 *          - For all except parameters 'InjectedDiscontinuousConvMode' and 'AutoInjectedConv': ADC enabled without
 * conversion on going on injected group.
 *          - For parameters 'ExternalTrigInjecConv' and 'ExternalTrigInjecConvEdge': ADC enabled, even with conversion
...
typedef struct {
    ...
    uint32_t InjectedSamplingTime; /*!< Sampling time value to be set for the selected channel.
                                        ...
                                        Conversion time is the addition of sampling time and processing time (12 ADC
                                      clock cycles at ADC resolution 12 bits, 11 cycles at 10 bits, 9 cycles at 8 bits,
                                      7 cycles at 6 bits). This parameter can be a value of @ref ADC_sampling_times
                                        Caution: This parameter updates the parameter property of the channel, that can
                                      be used into regular and/or injected groups. If this same channel has been
                                      previously configured in the other group (regular/injected), it will be updated to
                                      ...
                                      TS_temp (values rough order: 4us min). */
...
#endif /* STM32F411xE || STM32F413xx || STM32F423xx || STM32F427xx || STM32F437xx || STM32F429xx || STM32F439xx ||     \
...
#endif /* STM32F405xx || STM32F407xx || STM32F415xx || STM32F417xx || STM32F427xx || STM32F429xx || STM32F437xx ||     \
